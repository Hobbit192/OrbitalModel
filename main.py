    ...
    if game_state == "menu":
        for event in pygame.event.get():
            ...
            if event.type == pygame_gui.UI_BUTTON_PRESSED:
                ...
                if event.ui_element == controls_button:
                    game_state = "controls"
        ...
        for event in pygame.event.get():
            ...
            controls_manager.process_events(event)

        controls_manager.update(time_delta)
        screen.blit(controls_surface, (0, 0))
        controls_manager.draw_ui(controls_surface)
